#!/usr/bin/env python3
"""
Setup script for Python Practice Collection
"""
...
setup(
    ...
    version="1.0.0",
    author="Python Practice Contributors",
    author_email="contributors@python-practice.dev",
    description="A comprehensive collection of Python practice problems and solutions",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/username/python-practice",
